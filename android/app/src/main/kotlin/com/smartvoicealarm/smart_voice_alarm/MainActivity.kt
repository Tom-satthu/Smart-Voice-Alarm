...
class MainActivity : FlutterActivity() {
    ...
    private fun captureAlarmExtra(intent: Intent?) {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, alarmsChannel)
            .setMethodCallHandler { call, result ->
                when (call.method) {
                    "scheduleAlarm" -> {
                        val id = call.argument<String>("id") ?: return@setMethodCallHandler result.error("bad_args", "id", null)
